...
function EditProfilePage() {
    ...
    page.innerHTML = `
        <div class="edit-profile-card edit-profile-modern">
            ...
            <form id="edit-profile-form" enctype="multipart/form-data">
                <div class="edit-profile-grid">
                    <div class="edit-profile-left">
                        ...
                        <div class="form-group">
                            <label for="password">Nueva Contraseña <span class="hint">(dejar vacío para no cambiar)</span></label>
                    ...
                    <div class="edit-profile-right">
                        <label class="profile-image-label">Imagen de Perfil Actual</label>
